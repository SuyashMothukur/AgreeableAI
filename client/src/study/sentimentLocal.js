/**
 * Client-side mirrors of server/sentiment.js for offline analysis previews.
 * Replace with API-backed analysis when available.
 */

const POS =
  /\b(good|great|happy|relieved|grateful|fair|right|hope|thanks|love|proud|calm|okay|ok|better|support|understand|sorry|listen)\b/i;
const NEG =
  /\b(angry|furious|unfair|wrong|hate|hurt|anxious|stressed|guilty|ashamed|lonely|tired|exhausted|frustrat|upset|worried|afraid|sad|bad|never|always|worst|ruin|attack|blame)\b/i;
const CHALLENGE =
  /\b(however|but|actually|disagree|wrong|mistake|consider|risk|harm|unfair|inappropriate|instead|evidence|alternative)\b/i;
